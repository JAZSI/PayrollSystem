package com.com253.payrollsystem.infrastructure.logging;
...
public final class Logger {
    ...
    public static void info(String message) { log("INFO", BLUE, message); }
    public static void success(String message) { log("SUCCESS", GREEN, message); }
    public static void warn(String message) { log("WARNING", YELLOW, message); }
    public static void error(String message) { log("ERROR", RED, message); }
    public static void debug(String message) { log("DEBUG", MAGENTA, message); }
