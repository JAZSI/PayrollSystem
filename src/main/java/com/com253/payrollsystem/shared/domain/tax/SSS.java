...
/** SSS monthly contribution from salary brackets. */
public final class SSS {

    // {salary upper bound exclusive, contribution}
    ...
    /** Employer SSS (regular + MPF), excluding EC. Per the table this is 2x the employee share. */
    public static double employerContribution(double salary) {
        return 2.0 * monthlyContribution(salary);
    }

    /** Employer's Employees' Compensation (EC) premium: PHP 10 below MSC 15,000, else PHP 30. */
    public static double employerCompensation(double salary) {
        return salary < 14_750 ? 10.0 : 30.0;
    }
}
